...
![alt text](https://github.com/seungho0106/Documentation/blob/gh-pages/assets/images/exclamation-icon.png "Note icon")  **Note**: If you have your "Main Window" in full screen mode, you may need to hover over the top of your computer screen to see the toolbar.<br>
8. 
